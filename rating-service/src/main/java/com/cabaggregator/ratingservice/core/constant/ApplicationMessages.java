...
public final class ApplicationMessages {
    ...
    public static final String DRIVER_RATING_NOT_FOUND = "error.driver.rating.not.found";
    public static final String PASSENGER_RATING_NOT_FOUND = "error.passenger.rating.not.found";
